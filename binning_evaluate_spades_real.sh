...
python ~/software/GraphBin_New/support/prepResult.py --binned maxbin_cleaned --assembler spades --output maxbin_cleaned
...
python ~/software/GraphBin_New/support/prepResult.py --binned final.contigs.fa.metabat-bins1500_cleaned --assembler spades --output final.contigs.fa.metabat-bins1500_cleaned
python ~/software/GraphBin_New/support/prepResult.py --binned concoct_output --assembler spades --output concoct_output
python ~/software/GraphBin_New/support/prepResult.py --binned concoct_output_cleaned --assembler spades --output concoct_output_cleaned
python ~/software/GraphBin_New/support/prepResult.py --binned solidbin --assembler spades --output solidbin
python ~/software/GraphBin_New/support/prepResult.py --binned solidbin_cleaned --assembler spades --output solidbin_cleaned
python ~/software/GraphBin_New/support/prepResult.py --binned mycc --assembler spades --output mycc
python ~/software/GraphBin_New/support/prepResult.py --binned mycc_cleaned --assembler spades --output mycc_cleaned
...
if [ ! -f "assembler.log" ]; then
    ~/code/assembler/assembler ngs_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../align.megahit.bam ../maxbin_cleaned/initial_contig_bins.csv $4 $6 $7 $8 > assembler.log 2>&1
fi
end=`date +%s`
dif=$[ end - start ]
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../maxbin/initial_contig_bins.csv > evaluate.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin/graphbin_output.csv > evaluate.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final/final.cluster > evaluate.amgl
...
if [ ! -d "edge_graph_graphbin_magpurify" ]; then
    ~/software/GraphBin_New/graphbin --assembler spades --graph ../spades/assembly_graph_with_scaffolds.gfa --paths ../spades/contigs.paths --binned ../maxbin_cleaned/initial_contig_bins.csv --output edge_graph_graphbin_magpurify > edge_graph_graphbin_magpurify.log 2>&1
fi
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../maxbin_cleaned/initial_contig_bins.csv > evaluate_magpurify.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin_magpurify/graphbin_output.csv > evaluate_magpurify.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_magpurify/final.cluster > evaluate_magpurify.amgl

python ~/code/assembler/parse_result.py --assembler spades --cluster edge_graph_graphbin_magpurify/graphbin_output.csv --output edge_graph_graphbin_magpurify --contigs ../final.contigs.fa
python ~/code/assembler/parse_result.py --assembler spades --cluster final_magpurify/final.cluster --output final_magpurify --contigs ../final.contigs.fa
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_noremove/final.cluster > evaluate_noremove.amgl
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_noremove_magpurify/final.cluster > evaluate_magpurify_noremove.amgl
python ~/code/assembler/parse_result.py --assembler spades --cluster final_noremove/final.cluster --output final_noremove --contigs ../final.contigs.fa
python ~/code/assembler/parse_result.py --assembler spades --cluster final_noremove_magpurify/final.cluster --output final_noremove_magpurify --contigs ../final.contigs.fa
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_noremove_magpurify_cleaned/initial_contig_bins.csv > evaluate_magpurify_noremove_cleaned.amgl
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../final.contigs.fa.metabat-bins1500/initial_contig_bins.csv > evaluate.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin/graphbin_output.csv > evaluate.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final/final.cluster > evaluate.amgl
...
# maxbin with purify
if [ ! -d "edge_graph_graphbin_magpurify" ]; then
    ~/software/GraphBin_New/graphbin --assembler spades --graph ../spades/assembly_graph_with_scaffolds.gfa --paths ../spades/contigs.paths --binned ../final.contigs.fa.metabat-bins1500_cleaned/initial_contig_bins.csv --output edge_graph_graphbin_magpurify > edge_graph_graphbin_magpurify.log 2>&1
fi
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../final.contigs.fa.metabat-bins1500_cleaned/initial_contig_bins.csv > evaluate_magpurify.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin_magpurify/graphbin_output.csv > evaluate_magpurify.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_magpurify/final.cluster > evaluate_magpurify.amgl
...
python ~/software/GraphBin/support/prepResult.py --binned final_noremove_magpurify_cleaned --assembler megahit --output final_noremove_magpurify_cleaned
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_noremove_magpurify_cleaned/initial_contig_bins.csv > evaluate_magpurify_noremove_cleaned.amgl
# if [ ! -f "final_noremove_magpurify_cleaned.txt" ]; then
#     checkm lineage_wf -f final_noremove_magpurify_cleaned.txt -t 100 -x fasta final_noremove_magpurify_cleaned checkm_final_noremove_magpurify_cleaned > checkm_final_noremove_magpurify_cleaned.log 2>&1
# fi
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../concoct_output/initial_contig_bins.csv > evaluate.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin/graphbin_output.csv > evaluate.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final/final.cluster > evaluate.amgl
...
# maxbin with purify
if [ ! -d "edge_graph_graphbin_magpurify" ]; then
    ~/software/GraphBin_New/graphbin --assembler spades --graph ../spades/assembly_graph_with_scaffolds.gfa --paths ../spades/contigs.paths --binned ../concoct_output_cleaned/initial_contig_bins.csv --output edge_graph_graphbin_magpurify > edge_graph_graphbin_magpurify.log 2>&1
fi
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../concoct_output_cleaned/initial_contig_bins.csv > evaluate_magpurify.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin_magpurify/graphbin_output.csv > evaluate_magpurify.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_magpurify/final.cluster > evaluate_magpurify.amgl
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../solidbin/initial_contig_bins.csv > evaluate.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin/graphbin_output.csv > evaluate.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final/final.cluster > evaluate.amgl
...
# maxbin with purify
if [ ! -d "edge_graph_graphbin_magpurify" ]; then
    ~/software/GraphBin_New/graphbin --assembler spades --graph ../spades/assembly_graph_with_scaffolds.gfa --paths ../spades/contigs.paths --binned ../solidbin_cleaned/initial_contig_bins.csv --output edge_graph_graphbin_magpurify > edge_graph_graphbin_magpurify.log 2>&1
fi
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../solidbin_cleaned/initial_contig_bins.csv > evaluate_magpurify.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin_magpurify/graphbin_output.csv > evaluate_magpurify.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_magpurify/final.cluster > evaluate_magpurify.amgl
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../mycc/initial_contig_bins.csv > evaluate.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin/graphbin_output.csv > evaluate.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final/final.cluster > evaluate.amgl
...
# maxbin with purify
if [ ! -d "edge_graph_graphbin_magpurify" ]; then
    ~/software/GraphBin_New/graphbin --assembler spades --graph ../spades/assembly_graph_with_scaffolds.gfa --paths ../spades/contigs.paths --binned ../mycc_cleaned/initial_contig_bins.csv --output edge_graph_graphbin_magpurify > edge_graph_graphbin_magpurify.log 2>&1
fi
...
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv ../mycc_cleaned/initial_contig_bins.csv > evaluate_magpurify.maxbin
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv edge_graph_graphbin_magpurify/graphbin_output.csv > evaluate_magpurify.edge_graph
~/code/assembler/assembler evaluate_spades ../spades/assembly_graph.fastg ../spades/contigs.paths ../kraken2_0.9.tsv final_magpurify/final.cluster > evaluate_magpurify.amgl
