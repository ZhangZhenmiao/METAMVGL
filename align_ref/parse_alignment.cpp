...
int main() {
	...
	load_alignment("Acinetobacter_baumannii.bam");
	// load_alignment("Bacillus_cereus.bam");
	// load_alignment("Bacteroides_vulgatus.bam");
	// load_alignment("Bifidobacterium_adolescentis.bam");
	// load_alignment("Clostridium_beijerinckii.bam");
	// load_alignment("Cutibacterium_acnes.bam");
	// load_alignment("Deinococcus_radiodurans.bam");
	// load_alignment("Enterococcus_faecalis.bam");
	// load_alignment("Escherichia_coli.bam");
	// load_alignment("Helicobacter_pylori.bam");
	// load_alignment("Lactobacillus_gasseri.bam");
	// load_alignment("Neisseria_meningitidis.bam");
	// load_alignment("Porphyromonas_gingivalis.bam");
	// load_alignment("Pseudomonas_aeruginosa.bam");
	// load_alignment("Rhodobacter_sphaeroides.bam");
	// load_alignment("Schaalia_odontolytica.bam");
	// load_alignment("Staphylococcus_aureus.bam");
	// load_alignment("Staphylococcus_epidermidis.bam");
	load_alignment("Streptococcus_agalactiae.bam");
	load_alignment("Streptococcus_mutans.bam");
